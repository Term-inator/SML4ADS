...
public class MCar {
    ...
    public MCar(String name, String model, double maxSpeed, double initSpeed, int roadId, int laneSecId, int laneId, double offset, boolean heading, double roadDeviation, String mTree) {
        this.name = name;
        this.model = model;
